...
const constantRouterComponents = {
  ...
  // 仓库管理
  // -设备台账
  WareHouseEquipment: () => import('@/views/warehouse/equipment'),
  // -货架台账
  WareHouseShelves: () => import('@/views/warehouse/shelves'),
  // -任务管理
  WareHouseTask: () => import('@/views/warehouse/task'),
  // -日志管理
  WareHouseLogs: () => import('@/views/warehouse/logs'),
  // -异常管理
  WareHouseAlarm: () => import('@/views/warehouse/alarm'),

  // 设备任务
  // -任务台账
  EquipmentTaskEvents: () => import('@/views/equipmenttask/events'),
  // -设备操作
  EquipmentTaskActions: () => import('@/views/equipmenttask/actions'),

  // 告警通知
  // -设备告警
  NoticeEquipment: () => import('@/views/notice/equipment'),

  // 模拟操作入口
  Demo: () => import('@/views/notice/demo'),

  // 大屏
  Screen: () => import('@/views/screen'),

  // 运行日志
  LogsRunning: () => import('@/views/system/logs/running'),

  // 故障日志
  LogsError: () => import('@/views/system/logs/error'),

  // 用户管理
  'system/user/index': () => import('@/views/system/user'),
  // 角色管理
  'system/role/index': () => import('@/views/system/role')
}
