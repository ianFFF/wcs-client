  ...
  >
    ...
    <template v-slot:menuHeaderRender>
      <div>
        ...
        <!--
        <img src="~@/assets/dt-logo.png" class="logo" alt="logo" />
        <h1>{{ title }}</h1> -->
      </div>
    </template>
    ...
    <template v-slot:headerContentRender>
      <div style="display: flex;align-items: center;">
        ...
        <!-- <img src="~@/assets/dt-logo.png" class="logo" alt="logo" style="height:40px;" /> -->
        <span style="margin-left: 16px;font-size: 24px;font-weight: bold;">{{ title }}</span>
      </div>
    </template>
